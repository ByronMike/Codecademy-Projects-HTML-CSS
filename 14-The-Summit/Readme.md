# Link & Buttons - The Summit

Improve the user experience of a ski lodge landing page with CSS.
- [Online page - Codepen](https://codepen.io/ByronMike/pen/poVqOOd)
...
## Status
:heavy_check_mark: This project was validated on August 19, 2022.
